(()=>{function I(e){let t=-1/0;for(let i=0;i<e.length;i++)e[i]>t&&(t=e[i]);return t}function S(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function O(e){return S(typeof e=="number"?`${e}px`:e)}function Y(e){if(typeof e!="string"||e==="")return!1;try{let t=new URL(e,"http://localhost/");return t.protocol==="http:"||t.protocol==="https:"}catch{return!1}}function m(e,t=0,i=1){return Math.max(t,Math.min(e,i))}function ut(e){return e===void 0?void 0:e==="true"}function j(e){if(typeof e=="string"&&e.trim().startsWith("["))try{return JSON.parse(e)}catch{}return e}var pt=new Set(["svg","g","path","rect","circle","ellipse","line","polyline","polygon","defs","lineargradient","radialgradient","stop","title","desc","use"]),ft=new Set(["aria-hidden","class","clip-rule","cx","cy","d","fill","fill-opacity","fill-rule","focusable","height","href","id","offset","opacity","points","r","role","rx","ry","stroke","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke-width","stop-color","stop-opacity","transform","viewbox","width","x","x1","x2","xlink:href","xmlns","xmlns:xlink","y","y1","y2"]),G=!1;function mt(){G||(G=!0,console.warn("[WaveformPlayer] data-play-icon and data-pause-icon are deprecated; pass playIcon and pauseIcon through constructor options instead."))}function yt(e){let t=String(e||"").trim();return t===""||t.startsWith("#")}function K(e){if(e.nodeType===Node.TEXT_NODE)return;if(e.nodeType!==Node.ELEMENT_NODE){e.remove();return}let t=e.localName.toLowerCase();if(!pt.has(t)){e.remove();return}for(let i of Array.from(e.attributes)){let s=i.name.toLowerCase(),r=s.startsWith("data-"),a=(s==="href"||s==="xlink:href")&&!yt(i.value);(s.startsWith("on")||a||!r&&!ft.has(s))&&e.removeAttribute(i.name)}for(let i of Array.from(e.childNodes))K(i)}function J(e){if(typeof e!="string"||!e.trim()||typeof document>"u"||typeof Node>"u")return"";let t=document.createElement("template");t.innerHTML=e.trim();for(let i of Array.from(t.content.childNodes))K(i);return t.innerHTML.trim()}function R(e){let t={},i=(o,n=o)=>{let l=ut(e.dataset[n]);l!==void 0&&(t[o]=l)},s=(o,n=o,l=!1)=>{let h=e.dataset[n];h&&(t[o]=l?parseFloat(h):parseInt(h,10))},r=(o,n=o)=>{let l=e.dataset[n];l&&(t[o]=/^\d+(\.\d+)?$/.test(l.trim())?parseFloat(l):l)},a=(o,n=o)=>{let l=e.dataset[n];if(l)try{t[o]=JSON.parse(l)}catch(h){console.warn(`[WaveformPlayer] Invalid ${n} JSON:`,h)}};if(e.dataset.src&&(t.url=e.dataset.src),e.dataset.url&&(t.url=e.dataset.url),s("height"),s("samples"),e.dataset.preload&&(t.preload=e.dataset.preload),e.dataset.crossOrigin&&(t.crossOrigin=e.dataset.crossOrigin),e.dataset.audioMode&&(t.audioMode=e.dataset.audioMode),e.dataset.style&&(t.waveformStyle=e.dataset.style),e.dataset.waveformStyle&&(t.waveformStyle=e.dataset.waveformStyle),e.dataset.waveformGradient&&(t.waveformGradient=e.dataset.waveformGradient),s("barWidth"),s("barSpacing"),s("barRadius"),["auto","top","center","bottom"].includes(e.dataset.buttonAlign)&&(t.buttonAlign=e.dataset.buttonAlign),e.dataset.layout&&(t.layout=e.dataset.layout),e.dataset.buttonStyle&&(t.buttonStyle=e.dataset.buttonStyle),r("buttonSize"),r("buttonRadius"),e.dataset.colorPreset&&(t.colorPreset=e.dataset.colorPreset),e.dataset.waveformColor&&(t.waveformColor=j(e.dataset.waveformColor)),e.dataset.progressColor&&(t.progressColor=j(e.dataset.progressColor)),e.dataset.color&&(t.waveformColor=e.dataset.color),e.dataset.theme&&(t.colorPreset=e.dataset.theme),i("autoplay"),i("showControls"),i("showInfo"),i("showTime"),i("showHoverTime"),i("seekHandle"),i("showBPM","showBpm"),s("bpm"),i("singlePlay"),i("playOnSeek"),e.dataset.title&&(t.title=e.dataset.title),e.dataset.artist&&(t.artist=e.dataset.artist),e.dataset.album&&(t.album=e.dataset.album),e.dataset.artwork&&(t.artwork=e.dataset.artwork),e.dataset.artworkPosition&&(t.artworkPosition=e.dataset.artworkPosition),e.dataset.waveform&&(t.waveform=e.dataset.waveform),a("markers"),s("playbackRate","playbackRate",!0),i("showPlaybackSpeed"),e.dataset.playbackRates)try{let o=JSON.parse(e.dataset.playbackRates);Array.isArray(o)&&o.length>0&&o.every(n=>typeof n=="number"&&Number.isFinite(n)&&n>0)&&(t.playbackRates=o)}catch(o){console.warn("[WaveformPlayer] Invalid playbackRates JSON:",o)}if(i("enableMediaSession"),i("showMarkers"),i("accessibleSeek"),e.dataset.seekLabel&&(t.seekLabel=e.dataset.seekLabel),e.dataset.seekValueText&&(t.seekValueText=e.dataset.seekValueText),e.dataset.errorText&&(t.errorText=e.dataset.errorText),e.dataset.playPauseLabel&&(t.playPauseLabel=e.dataset.playPauseLabel),e.dataset.speedLabel&&(t.speedLabel=e.dataset.speedLabel),e.dataset.artworkAlt&&(t.artworkAlt=e.dataset.artworkAlt),e.dataset.unknownTrackText&&(t.unknownTrackText=e.dataset.unknownTrackText),e.dataset.playIcon||e.dataset.pauseIcon){mt();let o=J(e.dataset.playIcon),n=J(e.dataset.pauseIcon);o&&(t.playIcon=o),n&&(t.pauseIcon=n)}return t}function X(e,...t){let i=0;return e.replace(/%(?:(\d+)\$)?s/g,(s,r)=>{let a=r?Number(r)-1:i++;return t[a]??s})}function E(e){let t=Number(e);if(!t||!Number.isFinite(t)||t<0)return"0:00";let i=Math.floor(t/3600),s=Math.floor(t%3600/60),r=Math.floor(t%60);return i>0?`${i}:${s.toString().padStart(2,"0")}:${r.toString().padStart(2,"0")}`:`${s}:${r.toString().padStart(2,"0")}`}var gt=0;function Q(e){let t=e||"audio",i=5381;for(let s=0;s<t.length;s++)i=(i<<5)+i+t.charCodeAt(s)|0;return`wp_${(i>>>0).toString(36)}_${(gt++).toString(36)}`}function H(e){if(!e)return"Audio";let t=e.split("/");return t[t.length-1].split(".")[0].replace(/[-_]/g," ").replace(/\b\w/g,r=>r.toUpperCase())}function W(e){if(typeof e!="string")return null;let t=e.match(/rgba?\(\s*([\d.]+)\s*[,\s]\s*([\d.]+)\s*[,\s]\s*([\d.]+)\s*(?:[,/]\s*([\d.]+)(%?))?/i);if(!t)return null;let i=Number(t[1]),s=Number(t[2]),r=Number(t[3]);if(!Number.isFinite(i)||!Number.isFinite(s)||!Number.isFinite(r))return null;let a=t[4]===void 0?1:Number(t[4]);return Number.isFinite(a)?(t[5]==="%"&&(a/=100),{r:i,g:s,b:r,a:m(a,0,1)}):null}function Z(e){let t=W(e);return!t||t.a<=0?null:(t.r*299+t.g*587+t.b*114)/1e3}function B(...e){let t={};for(let i of e)for(let s in i)i[s]!==null&&i[s]!==void 0&&(t[s]=i[s]);return t}function tt(e,t){let i;return function(...r){let a=()=>{clearTimeout(i),e(...r)};clearTimeout(i),i=setTimeout(a,t)}}function D(e,t){if(e.length===t)return e;if(e.length===0||t===0)return[];let i=[];if(t>e.length){let s=(e.length-1)/(t-1);for(let r=0;r<t;r++){let a=r*s,o=Math.floor(a),n=Math.ceil(a),l=a-o;if(n>=e.length)i.push(e[e.length-1]);else if(o===n)i.push(e[o]);else{let h=e[o]*(1-l)+e[n]*l;i.push(h)}}}else{let s=e.length/t;for(let r=0;r<t;r++){let a=Math.floor(r*s),o=Math.floor((r+1)*s),n=0,l=0;for(let h=a;h<=o&&h<e.length;h++)e[h]>n&&(n=e[h]),l++;if(l===0){let h=Math.min(Math.round(r*s),e.length-1);n=e[h]}i.push(n)}}return i}function T(e,t,i,s){if(!Array.isArray(t))return t;if(t.length<2)return t[0];let r=i.width,a=i.height,o=s&&s.waveformGradient,[n,l,h,c]=o==="horizontal"?[0,0,r,0]:o==="diagonal"?[0,0,r,a]:[0,0,0,a];try{let u=e.createLinearGradient(n,l,h,c);return t.forEach((w,y)=>u.addColorStop(y/(t.length-1),w)),u}catch{return t[0]}}function _(e,t,i,s,r,a){if((Array.isArray(a)?a.some(n=>n>0):a>0)&&typeof e.roundRect=="function"){let n=Math.min(s/2,Math.abs(r)/2),l=h=>m(h,0,n);e.beginPath(),e.roundRect(t,i,s,r,Array.isArray(a)?a.map(l):l(a)),e.fill()}else e.fillRect(t,i,s,r)}function rt(e,t){return(e.barRadius||0)*t}function wt(e,t){let i=rt(e,t);return[i,i,0,0]}function et(e,t,i,s,r){let a=r/2;e.beginPath(),e.moveTo(t,s-a),e.lineTo(i-a,s-a),e.arc(i-a,s,a,-Math.PI/2,Math.PI/2),e.lineTo(t,s+a),e.arc(t,s,a,Math.PI/2,-Math.PI/2),e.closePath()}function N(e,t,i,s,r){let a=window.devicePixelRatio||1,o=r.barWidth*a,n=r.barSpacing*a,l=Math.floor(t.width/(o+n)),h=D(i,l),c=t.height,u=s*t.width,w=wt(r,a),y=T(e,r.color,t,r),k=T(e,r.progressColor,t,r);e.clearRect(0,0,t.width,t.height),e.fillStyle=y;for(let f=0;f<h.length;f++){let p=f*(o+n);if(p+o>t.width)break;let g=h[f]*c*.9,d=c-g;_(e,p,d,o,g,w)}e.save(),e.beginPath(),e.rect(0,0,u,c),e.clip(),e.fillStyle=k;for(let f=0;f<h.length;f++){let p=f*(o+n);if(p>u)break;let g=h[f]*c*.9,d=c-g;_(e,p,d,o,g,w)}e.restore()}function kt(e,t,i,s,r){let a=window.devicePixelRatio||1,o=r.barWidth*a,n=r.barSpacing*a,l=Math.floor(t.width/(o+n)),h=D(i,l),c=t.height,u=c/2,w=s*t.width,y=rt(r,a),k=[y,y,0,0],f=[0,0,y,y],p=T(e,r.color,t,r),g=T(e,r.progressColor,t,r);e.clearRect(0,0,t.width,t.height),e.fillStyle=p;for(let d=0;d<h.length;d++){let b=d*(o+n);if(b+o>t.width)break;let v=h[d]*c*.45;_(e,b,u-v,o,v,k),_(e,b,u,o,v,f)}e.save(),e.beginPath(),e.rect(0,0,w,c),e.clip(),e.fillStyle=g;for(let d=0;d<h.length;d++){let b=d*(o+n);if(b>w)break;let v=h[d]*c*.45;_(e,b,u-v,o,v,k),_(e,b,u,o,v,f)}e.restore()}function bt(e,t,i,s,r){let a=t.width,o=t.height,n=o/2,l=o*.35;e.clearRect(0,0,a,o);let h=(c,u,w=1,y=!1)=>{let k=T(e,c,t,r),f=Array.isArray(c)?c[c.length-1]:c;y&&(e.shadowBlur=12,e.shadowColor=f),e.strokeStyle=k,e.lineWidth=u,e.lineCap="round",e.lineJoin="round",e.beginPath(),e.moveTo(0,n);let p=[],g=Math.floor(i.length*w);for(let d=0;d<g;d++){let b=d/(i.length-1)*a,v=i[d],A=Math.sin(d*.1)*v,L=n+A*l;p.push({x:b,y:L})}for(let d=0;d<p.length-1;d++){let b=p[d].x+(p[d+1].x-p[d].x)*.5,v=p[d].y,A=p[d+1].x-(p[d+1].x-p[d].x)*.5,L=p[d+1].y;e.bezierCurveTo(b,v,A,L,p[d+1].x,p[d+1].y)}e.stroke(),y&&(e.shadowBlur=0)};e.strokeStyle="rgba(255, 255, 255, 0.03)",e.lineWidth=.5,e.beginPath(),e.moveTo(0,n),e.lineTo(a,n),e.stroke();for(let c=0;c<=10;c++){let u=a/10*c;e.beginPath(),e.moveTo(u,0),e.lineTo(u,o),e.stroke()}h(r.color,2,1,!1),s>0&&h(r.progressColor,3,s,!0)}function it(e,t,i,s,r){let a=window.devicePixelRatio||1,o=(r.barWidth||3)*a,n=(r.barSpacing||1)*a,l=Math.floor(t.width/(o+n)),h=D(i,l),c=t.height,u=4*a,w=2*a,y=s*t.width,k=c/2,f=T(e,r.color,t,r),p=T(e,r.progressColor,t,r);e.clearRect(0,0,t.width,t.height);for(let g=0;g<h.length;g++){let d=g*(o+n);if(d+o>t.width)break;let b=h[g]*c*.9,v=Math.floor(b/(u+w));e.fillStyle=d<y?p:f;for(let A=0;A<v;A++){let L=A*(u+w);e.fillRect(d,k-L-u,o,u),A>0&&e.fillRect(d,k+L,o,u)}}}function st(e,t,i,s,r){let a=window.devicePixelRatio||1,o=(r.barWidth||2)*a,n=(r.barSpacing||3)*a,l=Math.floor(t.width/(o+n)),h=D(i,l),c=t.height,u=Math.max(1.5*a,o/2),w=s*t.width,y=c/2,k=T(e,r.color,t,r),f=T(e,r.progressColor,t,r);e.clearRect(0,0,t.width,t.height);for(let p=0;p<h.length;p++){let g=p*(o+n)+o/2;if(g>t.width)break;let d=h[p]*c*.9;e.fillStyle=g<w?f:k,e.beginPath(),e.arc(g,y-d/2,u,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(g,y+d/2,u,0,Math.PI*2),e.fill()}}function vt(e,t,i,s,r){let a=t.width,o=t.height,n=o/2,l=4,h=l/2,c=!!r.seekActive;if(e.clearRect(0,0,a,o),e.fillStyle=T(e,r.color,t,r)||"rgba(255, 255, 255, 0.2)",et(e,h,a,n,l),e.fill(),s>0){let u=Math.max(h*2,s*a);e.save(),e.globalAlpha=r.seekHandle&&!c?.7:1,e.fillStyle=T(e,r.progressColor,t,r)||"rgba(255, 255, 255, 0.9)",et(e,h,u,n,l),e.fill(),e.restore()}}var St={bars:N,bar:N,mirror:kt,line:bt,blocks:it,block:it,dots:st,dot:st,seekbar:vt};function at(e,t,i,s,r){(St[r.waveformStyle]||N)(e,t,i,s,r)}function ot(e){try{let t=e.getChannelData(0),i=e.sampleRate,s=Et(t,i);if(s.length<2)return 120;let r=[];for(let l=1;l<s.length;l++)r.push((s[l]-s[l-1])/i);let a={};r.forEach(l=>{let h=60/l,c=Math.round(h/3)*3;c>60&&c<200&&(a[c]=(a[c]||0)+1)});let o=0,n=120;for(let[l,h]of Object.entries(a))h>o&&(o=h,n=parseInt(l));return n<70&&a[n*2]?n*=2:n>160&&a[Math.round(n/2)]&&(n=Math.round(n/2)),n-1}catch(t){return console.warn("[WaveformPlayer] BPM detection failed:",t),null}}function Et(e,t){let r=[],a=0;for(let o=0;o<e.length-2048;o+=1024){let n=0;for(let c=o;c<o+2048;c++)n+=e[c]*e[c];n=n/2048;let l=n-a,h=a*1.8+.01;if(l>h&&n>.01){let c=r[r.length-1]||0,u=t*.15;o-c>u&&r.push(o)}a=n*.8+a*.2}return r}function Tt(e,t=1800){let i=e.length/t,s=e.numberOfChannels,r=[];for(let o=0;o<s;o++){let n=e.getChannelData(o);for(let l=0;l<t;l++){let h=~~(l*i),c=~~(h+i),u=0,w=0;for(let k=h;k<c;k++){let f=n[k];f>w&&(w=f),f<u&&(u=f)}let y=Math.max(Math.abs(w),Math.abs(u));(o===0||y>r[l])&&(r[l]=y)}}let a=I(r);return a>0?r.map(o=>o/a):r}async function F(e,t=1800,i=!1){let s;try{let r=window.AudioContext||window.webkitAudioContext;s=new r;let o=await(await fetch(e)).arrayBuffer(),n=await s.decodeAudioData(o),l=Tt(n,t);l=Pt(l);let h=null;return i&&(h=ot(n)),{peaks:l,bpm:h}}finally{s&&s.close()}}function nt(e=1800){let t=[];for(let i=0;i<e;i++){let s=Math.random()*.5+.3,r=Math.sin(i/e*Math.PI*4)*.2;t.push(m(s+r,.1,1))}return t}function Pt(e,t=.95){let i=I(e);if(i===0||i>t)return e;let s=t/i;return e.map(r=>r*s)}var $=128;function lt(e){let t=document.documentElement,i=document.body;return t.classList.contains(e)||t.classList.contains(`${e}-mode`)||t.classList.contains(`theme-${e}`)||t.getAttribute("data-theme")===e||t.getAttribute("data-color-scheme")===e||i.classList.contains(e)||i.classList.contains(`${e}-mode`)||i.getAttribute("data-theme")===e}function At(e){let t=0,i=0;for(let s=e;s&&s.nodeType===1&&i<.995;s=s.parentElement){let r=W(getComputedStyle(s).backgroundColor);if(!r||r.a<=0)continue;let a=r.a*(1-i);t+=(r.r*299+r.g*587+r.b*114)/1e3*a,i+=a}return{sum:t,alpha:i}}function Mt(){let e=Z(getComputedStyle(document.body).color);if(e!==null)return e>$?"dark":"light";if(window.matchMedia){if(window.matchMedia("(prefers-color-scheme: dark)").matches)return"dark";if(window.matchMedia("(prefers-color-scheme: light)").matches)return"light"}return"dark"}function x(e){if(lt("dark"))return"dark";if(lt("light"))return"light";try{let t=e&&e.nodeType===1?e:document.body,{sum:i,alpha:s}=At(t),r=Mt(),a=i+(r==="dark"?0:255)*(1-s);return a>$?"light":a<$?"dark":r}catch{return"dark"}}var C={dark:{waveformColor:"rgba(255, 255, 255, 0.3)",progressColor:"rgba(255, 255, 255, 0.9)"},light:{waveformColor:"rgba(0, 0, 0, 0.2)",progressColor:"rgba(0, 0, 0, 0.8)"}};function z(e,t){if(e&&C[e])return C[e];let i=x(t);return C[i]}var q={url:"",height:64,samples:1800,preload:"metadata",crossOrigin:null,audioMode:"self",playbackRate:1,showPlaybackSpeed:!1,playbackRates:[.5,.75,1,1.25,1.5,1.75,2],buttonAlign:"auto",layout:"default",buttonStyle:"circle",buttonSize:null,buttonRadius:null,waveformStyle:"mirror",barWidth:2,barSpacing:0,barRadius:1,waveformGradient:"vertical",colorPreset:null,waveformColor:null,progressColor:null,autoplay:!1,showControls:!0,showInfo:!0,showTime:!0,showHoverTime:!1,seekHandle:!1,showBPM:!1,bpm:null,singlePlay:!0,playOnSeek:!0,enableMediaSession:!0,markers:[],showMarkers:!0,accessibleSeek:!0,seekLabel:null,seekValueText:null,title:null,artist:null,artwork:null,artworkPosition:"info",album:"",errorText:"Unable to load audio",playPauseLabel:"Play/Pause",speedLabel:"Playback speed",artworkAlt:"Album artwork",unknownTrackText:"Unknown Track",playIcon:'<svg viewBox="0 0 24 24" width="16" height="16"><path d="M8 5v14l11-7z"/></svg>',pauseIcon:'<svg viewBox="0 0 24 24" width="16" height="16"><path d="M6 4h4v16H6zM14 4h4v16h-4z"/></svg>',onLoad:null,onPlay:null,onPause:null,onEnd:null,onError:null,onTimeUpdate:null,onNextTrack:null,onPreviousTrack:null},ht={bars:{barWidth:3,barSpacing:1},mirror:{barWidth:2,barSpacing:2},line:{barWidth:2,barSpacing:0},blocks:{barWidth:4,barSpacing:2},dots:{barWidth:3,barSpacing:3},seekbar:{barWidth:1,barSpacing:0}};var Lt="data:image/svg+xml,"+encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect width="24" height="24" rx="4" fill="#71717a" fill-opacity="0.15"/><g fill="none" stroke="#a1a1aa" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="17" r="2.2"/><circle cx="17" cy="15" r="2.2"/><path d="M10.2 17V7l9-1.6v9"/></g></svg>'),ct=5,dt=10,_t='button, a[href], input, [role="slider"]',P=class e{static instances=new Map;static currentlyPlaying=null;constructor(t,i={}){if(this.container=typeof t=="string"?document.querySelector(t):t,!this.container)throw new Error("[WaveformPlayer] Container element not found");let s=R(this.container),r={...i};r.style&&!r.waveformStyle&&(r.waveformStyle=r.style),r.src&&!r.url&&(r.url=r.src),this.options=B(q,s,r);let a=z(this.options.colorPreset,this.container);this._autoTheme=this.options.colorPreset==null||!C[this.options.colorPreset],this._presetKeys=[],this._scheme=this.options.colorPreset&&C[this.options.colorPreset]?this.options.colorPreset:x(this.container);for(let[n,l]of Object.entries(a))(this.options[n]===null||this.options[n]===void 0)&&(this.options[n]=l,this._presetKeys.push(n));let o=ht[this.options.waveformStyle];o&&(s.barWidth===void 0&&i.barWidth===void 0&&(this.options.barWidth=o.barWidth),s.barSpacing===void 0&&i.barSpacing===void 0&&(this.options.barSpacing=o.barSpacing)),this.audio=null,this.canvas=null,this.ctx=null,this.waveformData=[],this.progress=0,this._activeMarkerIndex=-1,this._markerLabelTimer=null,this.isPlaying=!1,this.isLoading=!1,this.hasError=!1,this.updateTimer=null,this.resizeObserver=null,this._ac=new AbortController,this.id=this.container.id||Q(this.options.url),e.instances.set(this.id,this),e._watchTheme(),this.init(),setTimeout(()=>{this._emit("waveformplayer:ready",{player:this,url:this.options.url})},100)}_emit(t,i,s=!1){let r=new CustomEvent(t,{bubbles:!0,cancelable:s,detail:i});return this.container.dispatchEvent(r),r}_requestSeek(t){this._emit("waveformplayer:request-seek",{...this._buildTrackDetail(),percent:t},!0).defaultPrevented||(this.progress=t,this.drawWaveform?.())}init(){this.createDOM(),this.createAudio(),this.initPlaybackSpeed(),this.initKeyboardControls(),this.initSeekControl(),this.bindEvents(),this.setupResizeObserver(),requestAnimationFrame(()=>{this.resizeCanvas(),this.options.url&&this.load(this.options.url).then(()=>{this.options.autoplay&&this.play()?.catch(()=>{})}).catch(t=>{console.error("[WaveformPlayer] Failed to load audio:",t)})})}createDOM(){this.container.innerHTML="",this.container.className="waveform-player";let t=this.options.buttonAlign;t==="auto"&&(this.options.waveformStyle==="bars"?t="bottom":t="center"),this.options.layout==="preview"&&this.container.classList.add("waveform-layout-preview"),this.container.classList.toggle("waveform-theme-light",this._scheme==="light");let s=[];this.options.buttonSize!=null&&s.push(`--wfp-btn-size: ${O(this.options.buttonSize)}`),this.options.buttonRadius!=null&&s.push(`--wfp-btn-radius: ${O(this.options.buttonRadius)}`);let r=s.length?` style="${s.join("; ")};"`:"",a=this.options.artworkPosition==="button"&&this.options.artwork,o=a?`<img class="waveform-btn-artwork" src="${S(this.options.artwork)}" alt="" aria-hidden="true">`:"",n=this.options.showControls?`

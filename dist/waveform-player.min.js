(()=>{function D(){return typeof window<"u"&&typeof document<"u"}function U(e){let t=-1/0;for(let i=0;i<e.length;i++)e[i]>t&&(t=e[i]);return t}function S(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function j(e){return S(typeof e=="number"?`${e}px`:e)}function st(e){if(typeof e!="string"||e==="")return!1;try{let t=new URL(e,"http://localhost/");return t.protocol==="http:"||t.protocol==="https:"}catch{return!1}}function m(e,t=0,i=1){return Math.max(t,Math.min(e,i))}function x(e,t=null,i={}){let{min:s=-1/0,max:r=1/0,integer:a=!1}=i,o=typeof e=="number"?e:typeof e=="string"&&e.trim()!==""?Number(e):NaN;if(!Number.isFinite(o))return t;let n=m(o,s,r);return a?Math.round(n):n}function I(e,t=null){if(Array.isArray(e))return e;if(typeof e=="string"&&e.trim().startsWith("["))try{let i=JSON.parse(e);if(Array.isArray(i))return i}catch{}return t}function B(e,t={}){let{min:i=-1/0,max:s=1/0,fallback:r=null}=t,a=I(e);if(!a&&typeof e=="string"&&e.trim()!==""&&(a=e.split(/[,\s]+/)),!a)return r;let o=a.map(n=>x(n)).filter(n=>n!==null&&n>=i&&n<=s);return o.length?o:r}function rt(e,t,i=null){return t.includes(e)?e:i}function at(e){if(typeof e=="string"){let t=e.trim().toLowerCase();return t!==""&&t!=="false"&&t!=="0"}return!!e}function vt(e){return e===void 0?void 0:e==="true"}function it(e){if(typeof e=="string"&&e.trim().startsWith("["))try{return JSON.parse(e)}catch{}return e}function O(e){let t={},i=(o,n=o)=>{let l=vt(e.dataset[n]);l!==void 0&&(t[o]=l)},s=(o,n=o,l=!1)=>{let h=e.dataset[n];h&&(t[o]=l?parseFloat(h):parseInt(h,10))},r=(o,n=o)=>{let l=e.dataset[n];l&&(t[o]=/^\d+(\.\d+)?$/.test(l.trim())?parseFloat(l):l)},a=(o,n=o)=>{let l=e.dataset[n];if(!l)return;let h=I(l);h?t[o]=h:console.warn(`[WaveformPlayer] Invalid ${n} attribute, expected a JSON array:`,l)};if(e.dataset.src&&(t.url=e.dataset.src),e.dataset.url&&(t.url=e.dataset.url),s("height"),s("samples"),e.dataset.preload&&(t.preload=e.dataset.preload),e.dataset.crossOrigin&&(t.crossOrigin=e.dataset.crossOrigin),e.dataset.audioMode&&(t.audioMode=e.dataset.audioMode),e.dataset.style&&(t.waveformStyle=e.dataset.style),e.dataset.waveformStyle&&(t.waveformStyle=e.dataset.waveformStyle),e.dataset.waveformGradient&&(t.waveformGradient=e.dataset.waveformGradient),s("barWidth"),s("barSpacing"),s("barRadius"),e.dataset.buttonAlign&&(t.buttonAlign=e.dataset.buttonAlign),e.dataset.layout&&(t.layout=e.dataset.layout),e.dataset.buttonStyle&&(t.buttonStyle=e.dataset.buttonStyle),r("buttonSize"),r("buttonRadius"),e.dataset.colorPreset&&(t.colorPreset=e.dataset.colorPreset),e.dataset.waveformColor&&(t.waveformColor=it(e.dataset.waveformColor)),e.dataset.progressColor&&(t.progressColor=it(e.dataset.progressColor)),e.dataset.color&&(t.waveformColor=e.dataset.color),e.dataset.theme&&(t.colorPreset=e.dataset.theme),i("autoplay"),i("showControls"),i("showInfo"),i("showTime"),i("showHoverTime"),i("seekHandle"),i("showBPM","showBpm"),s("bpm"),i("singlePlay"),i("playOnSeek"),e.dataset.title&&(t.title=e.dataset.title),e.dataset.artist&&(t.artist=e.dataset.artist),e.dataset.album&&(t.album=e.dataset.album),e.dataset.artwork&&(t.artwork=e.dataset.artwork),e.dataset.artworkPosition&&(t.artworkPosition=e.dataset.artworkPosition),e.dataset.waveform&&(t.waveform=e.dataset.waveform),a("markers"),s("playbackRate","playbackRate",!0),i("showPlaybackSpeed"),e.dataset.playbackRates){let o=B(e.dataset.playbackRates);o?t.playbackRates=o:console.warn("[WaveformPlayer] Invalid playbackRates attribute:",e.dataset.playbackRates)}return i("enableMediaSession"),i("showMarkers"),i("accessibleSeek"),e.dataset.seekLabel&&(t.seekLabel=e.dataset.seekLabel),e.dataset.seekValueText&&(t.seekValueText=e.dataset.seekValueText),e.dataset.errorText&&(t.errorText=e.dataset.errorText),e.dataset.playPauseLabel&&(t.playPauseLabel=e.dataset.playPauseLabel),e.dataset.speedLabel&&(t.speedLabel=e.dataset.speedLabel),e.dataset.artworkAlt&&(t.artworkAlt=e.dataset.artworkAlt),e.dataset.unknownTrackText&&(t.unknownTrackText=e.dataset.unknownTrackText),e.dataset.playIcon&&(t.playIcon=e.dataset.playIcon),e.dataset.pauseIcon&&(t.pauseIcon=e.dataset.pauseIcon),t}function ot(e,...t){let i=0;return e.replace(/%(?:(\d+)\$)?s/g,(s,r)=>{let a=r?Number(r)-1:i++;return t[a]??s})}function E(e){let t=Number(e);if(!t||!Number.isFinite(t)||t<0)return"0:00";let i=Math.floor(t/3600),s=Math.floor(t%3600/60),r=Math.floor(t%60);return i>0?`${i}:${s.toString().padStart(2,"0")}:${r.toString().padStart(2,"0")}`:`${s}:${r.toString().padStart(2,"0")}`}var St=0;function nt(e){let t=e||"audio",i=5381;for(let s=0;s<t.length;s++)i=(i<<5)+i+t.charCodeAt(s)|0;return`wp_${(i>>>0).toString(36)}_${(St++).toString(36)}`}function W(e){if(!e)return"Audio";let t=e.split("/");return t[t.length-1].split(".")[0].replace(/[-_]/g," ").replace(/\b\w/g,r=>r.toUpperCase())}function V(e){if(typeof e!="string")return null;let t=e.match(/rgba?\(\s*([\d.]+)\s*[,\s]\s*([\d.]+)\s*[,\s]\s*([\d.]+)\s*(?:[,/]\s*([\d.]+)(%?))?/i);if(!t)return null;let i=Number(t[1]),s=Number(t[2]),r=Number(t[3]);if(!Number.isFinite(i)||!Number.isFinite(s)||!Number.isFinite(r))return null;let a=t[4]===void 0?1:Number(t[4]);return Number.isFinite(a)?(t[5]==="%"&&(a/=100),{r:i,g:s,b:r,a:m(a,0,1)}):null}function lt(e){let t=V(e);return!t||t.a<=0?null:(t.r*299+t.g*587+t.b*114)/1e3}function G(...e){let t={};for(let i of e)for(let s in i)i[s]!==null&&i[s]!==void 0&&(t[s]=i[s]);return t}function ht(e,t){let i;return function(...r){let a=()=>{clearTimeout(i),e(...r)};clearTimeout(i),i=setTimeout(a,t)}}function H(e,t){if(e.length===t)return e;if(e.length===0||t===0)return[];let i=[];if(t>e.length){let s=(e.length-1)/(t-1);for(let r=0;r<t;r++){let a=r*s,o=Math.floor(a),n=Math.ceil(a),l=a-o;if(n>=e.length)i.push(e[e.length-1]);else if(o===n)i.push(e[o]);else{let h=e[o]*(1-l)+e[n]*l;i.push(h)}}}else{let s=e.length/t;for(let r=0;r<t;r++){let a=Math.floor(r*s),o=Math.floor((r+1)*s),n=0,l=0;for(let h=a;h<=o&&h<e.length;h++)e[h]>n&&(n=e[h]),l++;if(l===0){let h=Math.min(Math.round(r*s),e.length-1);n=e[h]}i.push(n)}}return i}function P(e,t,i,s){if(!Array.isArray(t))return t;if(t.length<2)return t[0];let r=i.width,a=i.height,o=s&&s.waveformGradient,[n,l,h,c]=o==="horizontal"?[0,0,r,0]:o==="diagonal"?[0,0,r,a]:[0,0,0,a];try{let d=e.createLinearGradient(n,l,h,c);return t.forEach((w,y)=>d.addColorStop(y/(t.length-1),w)),d}catch{return t[0]}}function _(e,t,i,s,r,a){if((Array.isArray(a)?a.some(n=>n>0):a>0)&&typeof e.roundRect=="function"){let n=Math.min(s/2,Math.abs(r)/2),l=h=>m(h,0,n);e.beginPath(),e.roundRect(t,i,s,r,Array.isArray(a)?a.map(l):l(a)),e.fill()}else e.fillRect(t,i,s,r)}function pt(e,t){return(e.barRadius||0)*t}function Et(e,t){let i=pt(e,t);return[i,i,0,0]}function ct(e,t,i,s,r){let a=r/2;e.beginPath(),e.moveTo(t,s-a),e.lineTo(i-a,s-a),e.arc(i-a,s,a,-Math.PI/2,Math.PI/2),e.lineTo(t,s+a),e.arc(t,s,a,Math.PI/2,-Math.PI/2),e.closePath()}function K(e,t,i,s,r){let a=window.devicePixelRatio||1,o=r.barWidth*a,n=r.barSpacing*a,l=Math.floor(t.width/(o+n)),h=H(i,l),c=t.height,d=s*t.width,w=Et(r,a),y=P(e,r.color,t,r),b=P(e,r.progressColor,t,r);e.clearRect(0,0,t.width,t.height),e.fillStyle=y;for(let f=0;f<h.length;f++){let p=f*(o+n);if(p+o>t.width)break;let g=h[f]*c*.9,u=c-g;_(e,p,u,o,g,w)}e.save(),e.beginPath(),e.rect(0,0,d,c),e.clip(),e.fillStyle=b;for(let f=0;f<h.length;f++){let p=f*(o+n);if(p>d)break;let g=h[f]*c*.9,u=c-g;_(e,p,u,o,g,w)}e.restore()}function Pt(e,t,i,s,r){let a=window.devicePixelRatio||1,o=r.barWidth*a,n=r.barSpacing*a,l=Math.floor(t.width/(o+n)),h=H(i,l),c=t.height,d=c/2,w=s*t.width,y=pt(r,a),b=[y,y,0,0],f=[0,0,y,y],p=P(e,r.color,t,r),g=P(e,r.progressColor,t,r);e.clearRect(0,0,t.width,t.height),e.fillStyle=p;for(let u=0;u<h.length;u++){let k=u*(o+n);if(k+o>t.width)break;let v=h[u]*c*.45;_(e,k,d-v,o,v,b),_(e,k,d,o,v,f)}e.save(),e.beginPath(),e.rect(0,0,w,c),e.clip(),e.fillStyle=g;for(let u=0;u<h.length;u++){let k=u*(o+n);if(k>w)break;let v=h[u]*c*.45;_(e,k,d-v,o,v,b),_(e,k,d,o,v,f)}e.restore()}function Tt(e,t,i,s,r){let a=t.width,o=t.height,n=o/2,l=o*.35;e.clearRect(0,0,a,o);let h=(c,d,w=1,y=!1)=>{let b=P(e,c,t,r),f=Array.isArray(c)?c[c.length-1]:c;y&&(e.shadowBlur=12,e.shadowColor=f),e.strokeStyle=b,e.lineWidth=d,e.lineCap="round",e.lineJoin="round",e.beginPath(),e.moveTo(0,n);let p=[],g=Math.floor(i.length*w);for(let u=0;u<g;u++){let k=u/(i.length-1)*a,v=i[u],A=Math.sin(u*.1)*v,L=n+A*l;p.push({x:k,y:L})}for(let u=0;u<p.length-1;u++){let k=p[u].x+(p[u+1].x-p[u].x)*.5,v=p[u].y,A=p[u+1].x-(p[u+1].x-p[u].x)*.5,L=p[u+1].y;e.bezierCurveTo(k,v,A,L,p[u+1].x,p[u+1].y)}e.stroke(),y&&(e.shadowBlur=0)};e.strokeStyle="rgba(255, 255, 255, 0.03)",e.lineWidth=.5,e.beginPath(),e.moveTo(0,n),e.lineTo(a,n),e.stroke();for(let c=0;c<=10;c++){let d=a/10*c;e.beginPath(),e.moveTo(d,0),e.lineTo(d,o),e.stroke()}h(r.color,2,1,!1),s>0&&h(r.progressColor,3,s,!0)}function ut(e,t,i,s,r){let a=window.devicePixelRatio||1,o=(r.barWidth||3)*a,n=(r.barSpacing||1)*a,l=Math.floor(t.width/(o+n)),h=H(i,l),c=t.height,d=4*a,w=2*a,y=s*t.width,b=c/2,f=P(e,r.color,t,r),p=P(e,r.progressColor,t,r);e.clearRect(0,0,t.width,t.height);for(let g=0;g<h.length;g++){let u=g*(o+n);if(u+o>t.width)break;let k=h[g]*c*.9,v=Math.floor(k/(d+w));e.fillStyle=u<y?p:f;for(let A=0;A<v;A++){let L=A*(d+w);e.fillRect(u,b-L-d,o,d),A>0&&e.fillRect(u,b+L,o,d)}}}function dt(e,t,i,s,r){let a=window.devicePixelRatio||1,o=(r.barWidth||2)*a,n=(r.barSpacing||3)*a,l=Math.floor(t.width/(o+n)),h=H(i,l),c=t.height,d=Math.max(1.5*a,o/2),w=s*t.width,y=c/2,b=P(e,r.color,t,r),f=P(e,r.progressColor,t,r);e.clearRect(0,0,t.width,t.height);for(let p=0;p<h.length;p++){let g=p*(o+n)+o/2;if(g>t.width)break;let u=h[p]*c*.9;e.fillStyle=g<w?f:b,e.beginPath(),e.arc(g,y-u/2,d,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(g,y+u/2,d,0,Math.PI*2),e.fill()}}function At(e,t,i,s,r){let a=t.width,o=t.height,n=o/2,l=4,h=l/2,c=!!r.seekActive;if(e.clearRect(0,0,a,o),e.fillStyle=P(e,r.color,t,r)||"rgba(255, 255, 255, 0.2)",ct(e,h,a,n,l),e.fill(),s>0){let d=Math.max(h*2,s*a);e.save(),e.globalAlpha=r.seekHandle&&!c?.7:1,e.fillStyle=P(e,r.progressColor,t,r)||"rgba(255, 255, 255, 0.9)",ct(e,h,d,n,l),e.fill(),e.restore()}}var Mt={bars:K,bar:K,mirror:Pt,line:Tt,blocks:ut,block:ut,dots:dt,dot:dt,seekbar:At};function ft(e,t,i,s,r){(Mt[r.waveformStyle]||K)(e,t,i,s,r)}function mt(e){try{let t=e.getChannelData(0),i=e.sampleRate,s=Ct(t,i);if(s.length<2)return 120;let r=[];for(let l=1;l<s.length;l++)r.push((s[l]-s[l-1])/i);let a={};r.forEach(l=>{let h=60/l,c=Math.round(h/3)*3;c>60&&c<200&&(a[c]=(a[c]||0)+1)});let o=0,n=120;for(let[l,h]of Object.entries(a))h>o&&(o=h,n=parseInt(l));return n<70&&a[n*2]?n*=2:n>160&&a[Math.round(n/2)]&&(n=Math.round(n/2)),n-1}catch(t){return console.warn("[WaveformPlayer] BPM detection failed:",t),null}}function Ct(e,t){let r=[],a=0;for(let o=0;o<e.length-2048;o+=1024){let n=0;for(let c=o;c<o+2048;c++)n+=e[c]*e[c];n=n/2048;let l=n-a,h=a*1.8+.01;if(l>h&&n>.01){let c=r[r.length-1]||0,d=t*.15;o-c>d&&r.push(o)}a=n*.8+a*.2}return r}function Lt(e,t=1800){let i=e.length/t,s=e.numberOfChannels,r=[];for(let o=0;o<s;o++){let n=e.getChannelData(o);for(let l=0;l<t;l++){let h=~~(l*i),c=~~(h+i),d=0,w=0;for(let b=h;b<c;b++){let f=n[b];f>w&&(w=f),f<d&&(d=f)}let y=Math.max(Math.abs(w),Math.abs(d));(o===0||y>r[l])&&(r[l]=y)}}let a=U(r);return a>0?r.map(o=>o/a):r}async function Y(e,t=1800,i=!1){let s;try{let r=window.AudioContext||window.webkitAudioContext;s=new r;let o=await(await fetch(e)).arrayBuffer(),n=await s.decodeAudioData(o),l=Lt(n,t);l=xt(l);let h=null;return i&&(h=mt(n)),{peaks:l,bpm:h}}finally{s&&s.close()}}function yt(e=1800){let t=[];for(let i=0;i<e;i++){let s=Math.random()*.5+.3,r=Math.sin(i/e*Math.PI*4)*.2;t.push(m(s+r,.1,1))}return t}function xt(e,t=.95){let i=U(e);if(i===0||i>t)return e;let s=t/i;return e.map(r=>r*s)}var J=128;function gt(e){let t=document.documentElement,i=document.body;return t.classList.contains(e)||t.classList.contains(`${e}-mode`)||t.classList.contains(`theme-${e}`)||t.getAttribute("data-theme")===e||t.getAttribute("data-color-scheme")===e||i.classList.contains(e)||i.classList.contains(`${e}-mode`)||i.getAttribute("data-theme")===e}function _t(e){let t=0,i=0;for(let s=e;s&&s.nodeType===1&&i<.995;s=s.parentElement){let r=V(getComputedStyle(s).backgroundColor);if(!r||r.a<=0)continue;let a=r.a*(1-i);t+=(r.r*299+r.g*587+r.b*114)/1e3*a,i+=a}return{sum:t,alpha:i}}function Rt(){let e=lt(getComputedStyle(document.body).color);if(e!==null)return e>J?"dark":"light";if(window.matchMedia){if(window.matchMedia("(prefers-color-scheme: dark)").matches)return"dark";if(window.matchMedia("(prefers-color-scheme: light)").matches)return"light"}return"dark"}function R(e){if(gt("dark"))return"dark";if(gt("light"))return"light";try{let t=e&&e.nodeType===1?e:document.body,{sum:i,alpha:s}=_t(t),r=Rt(),a=i+(r==="dark"?0:255)*(1-s);return a>J?"light":a<J?"dark":r}catch{return"dark"}}var C={dark:{waveformColor:"rgba(255, 255, 255, 0.3)",progressColor:"rgba(255, 255, 255, 0.9)"},light:{waveformColor:"rgba(0, 0, 0, 0.2)",progressColor:"rgba(0, 0, 0, 0.8)"}};function Q(e,t){if(e&&C[e])return C[e];let i=R(t);return C[i]}var N={url:"",height:64,samples:1800,preload:"metadata",crossOrigin:null,audioMode:"self",playbackRate:1,showPlaybackSpeed:!1,playbackRates:[.5,.75,1,1.25,1.5,1.75,2],buttonAlign:"auto",layout:"default",buttonStyle:"circle",buttonSize:null,buttonRadius:null,waveformStyle:"mirror",barWidth:2,barSpacing:0,barRadius:1,waveformGradient:"vertical",colorPreset:null,waveformColor:null,progressColor:null,autoplay:!1,showControls:!0,showInfo:!0,showTime:!0,showHoverTime:!1,seekHandle:!1,showBPM:!1,bpm:null,singlePlay:!0,playOnSeek:!0,enableMediaSession:!0,markers:[],showMarkers:!0,accessibleSeek:!0,seekLabel:null,seekValueText:null,title:null,artist:null,artwork:null,artworkPosition:"info",album:"",errorText:"Unable to load audio",playPauseLabel:"Play/Pause",speedLabel:"Playback speed",artworkAlt:"Album artwork",unknownTrackText:"Unknown Track",playIcon:'<svg viewBox="0 0 24 24" width="16" height="16"><path d="M8 5v14l11-7z"/></svg>',pauseIcon:'<svg viewBox="0 0 24 24" width="16" height="16"><path d="M6 4h4v16H6zM14 4h4v16h-4z"/></svg>',onLoad:null,onPlay:null,onPause:null,onEnd:null,onError:null,onTimeUpdate:null,onNextTrack:null,onPreviousTrack:null},Z={bars:{barWidth:3,barSpacing:1},mirror:{barWidth:2,barSpacing:2},line:{barWidth:2,barSpacing:0},blocks:{barWidth:4,barSpacing:2},dots:{barWidth:3,barSpacing:3},seekbar:{barWidth:1,barSpacing:0}},tt=["auto","top","center","bottom"],F=.25,z=4,Dt={buttonAlign:tt,layout:["default","preview"],buttonStyle:["circle","minimal"],artworkPosition:["info","button"],waveformStyle:Object.keys(Z),waveformGradient:["vertical","horizontal","diagonal"],audioMode:["self","external"],preload:["none","metadata","auto"],colorPreset:Object.keys(C),crossOrigin:["anonymous","use-credentials"]},Bt={height:{min:1,integer:!0},samples:{min:1,integer:!0},barWidth:{min:0},barSpacing:{min:0},barRadius:{min:0},bpm:{min:1},playbackRate:{min:F,max:z}},Ht=["autoplay","showControls","showInfo","showTime","showHoverTime","seekHandle","showBPM","singlePlay","playOnSeek","enableMediaSession","showMarkers","accessibleSeek","showPlaybackSpeed"],It=["onLoad","onPlay","onPause","onEnd","onError","onTimeUpdate","onNextTrack","onPreviousTrack"];function X(e,t){console.warn(`[WaveformPlayer] Invalid ${e} option, using default:`,t)}function $(e){let t=I(e);return t?t.reduce((i,s)=>{let r=s&&typeof s=="object"?x(s.time,null,{min:0}):null;return r===null?(X("marker",s),i):(i.push({...s,time:r,label:s.label==null?"":s.label}),i)},[]):(e!=null&&X("markers",e),[])}function et(e){let t=s=>e[s]!=null,i=s=>{X(s,e[s]),e[s]=N[s]};for(let[s,r]of Object.entries(Bt)){if(!t(s))continue;let a=x(e[s],null,r);a===null?i(s):e[s]=a}for(let[s,r]of Object.entries(Dt))t(s)&&rt(e[s],r)===null&&i(s);for(let s of Ht)e[s]=at(e[s]);for(let s of It)t(s)&&typeof e[s]!="function"&&i(s);if(t("playbackRates")){let s=B(e.playbackRates,{min:F,max:z,fallback:null});s===null?i("playbackRates"):e.playbackRates=s}e.markers=$(e.markers);for(let s of["buttonSize","buttonRadius"]){if(!t(s))continue;let r=e[s];(typeof r=="number"?Number.isFinite(r):typeof r=="string"&&r.trim()!=="")||i(s)}for(let s of["waveformColor","progressColor"]){if(!t(s))continue;let r=e[s];!(typeof r=="string"&&r.trim()!=="")&&!Array.isArray(r)&&i(s)}return e}var Ot="data:image/svg+xml,"+encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect width="24" height="24" rx="4" fill="#71717a" fill-opacity="0.15"/><g fill="none" stroke="#a1a1aa" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="17" r="2.2"/><circle cx="17" cy="15" r="2.2"/><path d="M10.2 17V7l9-1.6v9"/></g></svg>'),wt=5,bt=10,Wt='button, a[href], input, [role="slider"]',T=class e{static instances=new Map;static currentlyPlaying=null;constructor(t,i={}){if(this.container=typeof t=="string"?document.querySelector(t):t,!this.container)throw new Error("[WaveformPlayer] Container element not found");let s=O(this.container),r={...i};r.style&&!r.waveformStyle&&(r.waveformStyle=r.style),r.src&&!r.url&&(r.url=r.src),this.options=et(G(N,s,r));let a=Q(this.options.colorPreset,this.container);this._autoTheme=this.options.colorPreset==null||!C[this.options.colorPreset],this._presetKeys=[],this._scheme=this.options.colorPreset&&C[this.options.colorPreset]?this.options.colorPreset:R(this.container);for(let[n,l]of Object.entries(a))(this.options[n]===null||this.options[n]===void 0)&&(this.options[n]=l,this._presetKeys.push(n));let o=Z[this.options.waveformStyle];o&&(s.barWidth===void 0&&i.barWidth===void 0&&(this.options.barWidth=o.barWidth),s.barSpacing===void 0&&i.barSpacing===void 0&&(this.options.barSpacing=o.barSpacing)),this.audio=null,this.canvas=null,this.ctx=null,this.waveformData=[],this.progress=0,this._activeMarkerIndex=-1,this._markerLabelTimer=null,this.isPlaying=!1,this.isLoading=!1,this.hasError=!1,this.updateTimer=null,this.resizeObserver=null,this._ac=new AbortController,this.id=this.container.id||nt(this.options.url),e.instances.set(this.id,this),e._watchTheme();try{this.init()}catch(n){throw e.instances.delete(this.id),this._ac.abort(),n}setTimeout(()=>{this._emit("waveformplayer:ready",{player:this,url:this.options.url})},100)}_emit(t,i,s=!1){let r=new CustomEvent(t,{bubbles:!0,cancelable:s,detail:i});return this.container.dispatchEvent(r),r}_requestSeek(t){this._emit("waveformplayer:request-seek",{...this._buildTrackDetail(),percent:t},!0).defaultPrevented||(this.progress=t,this.drawWaveform?.())}init(){this.createDOM(),this.createAudio(),this.initPlaybackSpeed(),this.initKeyboardControls(),this.initSeekControl(),this.bindEvents(),this.setupResizeObserver(),requestAnimationFrame(()=>{this.resizeCanvas(),this.options.url&&this.load(this.options.url).then(()=>{this.options.autoplay&&this.play()?.catch(()=>{})}).catch(t=>{console.error("[WaveformPlayer] Failed to load audio:",t)})})}createDOM(){this.container.innerHTML="",this.container.className="waveform-player";let t=tt.includes(this.options.buttonAlign)?this.options.buttonAlign:"auto";t==="auto"&&(this.options.waveformStyle==="bars"?t="bottom":t="center"),this.options.layout==="preview"&&this.container.classList.add("waveform-layout-preview"),this.container.classList.toggle("waveform-theme-light",this._scheme==="light");let s=[];this.options.buttonSize!=null&&s.push(`--wfp-btn-size: ${j(this.options.buttonSize)}`),this.options.buttonRadius!=null&&s.push(`--wfp-btn-radius: ${j(this.options.buttonRadius)}`);let r=s.length?` style="${s.join("; ")};"`:"",a=this.options.artworkPosition==="button"&&this.options.artwork,o=a?`<img class="waveform-btn-artwork" src="${S(this.options.artwork)}" alt="" aria-hidden="true">`:"",n=this.options.showControls?`
